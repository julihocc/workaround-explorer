...
console.log("🚀 ~ file: main.js ~ line 13 ~ companies", companies)
const roles = getRoles();
console.log("🚀 ~ file: main.js ~ line 15 ~ roles", roles)
...
function renderInputButtons(labels, groupName) {
  console.log("🚀 ~ file: main.js ~ line 24 ~ renderInputButtons ~ groupName", groupName)
  console.log("🚀 ~ file: main.js ~ line 24 ~ renderInputButtons ~ labels", labels)
